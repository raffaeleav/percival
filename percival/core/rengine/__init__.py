...
cchecker_files = {"dive.json", "ccheck.json"}
...
prompts = {
    "executive_summary": (
        ...
        "Write the paragraph in natural language (Do NOT use Markdown, e.g. no #, ##, **, *, -, or backticks)." 
    ),
    "intermediate_report": (
        ...
        "Read the provided json findings and write an overview in natural language (Do NOT use Markdown, e.g. no #, ##, **, *, -, or backticks)." 
